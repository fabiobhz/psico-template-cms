...
const Testimonials = () => {
  ...
  return (
    <section id="testimonials" className="py-28 md:py-36 bg-secondary/50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {testimonials.items.map((t, index) => (
            <AnimatedSection key={t.id} delay={index * 0.1}>
              <div className="bg-background rounded-2xl p-6 shadow-sm border border-border flex flex-col h-full">
                {/* Header */}
                ...
                {t.source && (
                  <div className="flex items-center gap-1.5 mt-4 pt-4 border-t border-border">
                    {t.source.toLowerCase().includes("google") && <GoogleIcon />}
